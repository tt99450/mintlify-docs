...
description: "BigBlueButton is an open-source virtual classroom with built-in tools for active learning and live analytics to ensure every student learns."
icon: "hand-wave"
---
...
The documentation is organized Prepare (before the class) → Educate (teaching) → Reflect (after the class).
