...
![BN Reports intercepting the Analytics Callback and writing to Moodle's database tables](/images/analytics/image_008.png)
...
![BigBlueButton session start callback to the LMS retrieving roster, student analytics, and alerts](/images/analytics/image_011.png)
