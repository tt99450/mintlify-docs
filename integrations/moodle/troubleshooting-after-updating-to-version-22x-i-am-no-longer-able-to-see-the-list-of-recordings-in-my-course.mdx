...
![Moodle notice about the deprecated RecordingsBN plugin after updating to BigBlueButtonBN 2.2.x](/images/mceclip1_9.png)
...
![Adding a BigBlueButtonBN activity configured in Recordings only mode](/images/mceclip3_2.png)
