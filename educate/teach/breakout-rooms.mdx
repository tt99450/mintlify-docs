...
You can invite other moderators to specific breakout rooms for co-facilitation. See [Invite Moderators to Breakout Rooms](/help/moderator-guide/create-and-manage-breakout-rooms).
...
- **Export shared notes** — save collaborative text from each room. See [Export Breakout Room Shared Notes](/help/moderator-guide/access-breakout-room-whiteboards-or-shared-notes).
- **Export whiteboard annotations** — save drawings and annotations from each room. See [Export Breakout Room Whiteboard Annotations](/help/moderator-guide/access-breakout-room-whiteboards-or-shared-notes).
