...
- **Blur your background** for privacy. See [Change Webcam Background](/help/user-guide/share-a-webcam)
- **Disable self-view** if your own video is distracting. See [Disable Self-View](/help/releases/disable-self-view-of-webcam)
- **Pin important webcams** to keep them visible. See [Pin a Webcam](/help/user-guide/share-a-webcam#how-do-i-pin-my-webcam)
- **Adjust brightness** if your webcam image is too dark. See [Adjust Brightness](/help/user-guide/share-a-webcam#how-do-i-adjust-my-webcams-brightness)
...
- **Enable download** if students need the slides for reference. See [Download Original Presentation](/help/presenter-guide/upload-a-presentation-enable-for-download)
