...
**Lock viewers** - opens another menu with more granular options.  See the following [article](/help/moderator-guide/lock-viewers-ability-to-use-their-mic-webcam-chat-shared-notes) for more information.

**Guest policy** - sets the session user access policy.  See the following [article](/help/moderator-guide/guest-policy) for more information.
