...
Before a user can share their the webcam, the browser will [ask for permission](/help/user-guide/share-a-webcam) to access the user's webcam.  On Mac OS X, the operating system will also ask (one time) [for permission as well](/help/troubleshooting/mac-os-updates-bigbluebutton-media-permissions).
