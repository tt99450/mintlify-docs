...
1. Use your smart phone to setup a temporary wireless hotspot

2. Connect your computer to the phone's wireless hotspot

3. Join a test session again at https://my.bigbluebutton.com/

If the test session still disconnects with the hotspot, the issue may be with your computer and not the internet connection.
...
3. Try from a different home computer.
