...
description: "For some LaTeX documents, the mathematical symbols using bitmap fonts may not convert well (whereas OTF and TTF fonts are handled well). Using..."
---
