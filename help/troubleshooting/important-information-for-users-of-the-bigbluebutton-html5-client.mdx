...
These features were present in the Flash client and are not yet in the HTML5 client
...
![Settings menu opened to access the Data savings options](/images/mceclip0_9.png)

and then choose "Data savings" and turn off "Enable webcams".

![Data savings panel with the Enable webcams toggle turned off](/images/mceclip1_8.png)
