...
description: "You can view and manage your recordings. Room recordings: allows you to manage and view recordings that were made in a specific room. "
---
...
**_\*\*It is important to note that an unpublished recording can still be shared with individuals who do not have access to the personal room link if they are given the recording playback URL directly\*\*_**
...
_\*\*If you are using Blindside Networks' hosting, we can recover deleted recordings up to 14 days from the date of the_ **_live_** _session\*\*_

### **All Recordings**

You can also view and manage all recordings associated with your account, by clicking on the home icon <img src="/images/21823501648269.png" alt="Home icon" />, then the recordings tab.
...
![Screen_Shot_2019-07-25_at_3.43.07_PM.png](/images/360034095012.png)
