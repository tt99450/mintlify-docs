...
description: "By default, the automatic transcription language selector is disabled. To have your voice transcribed you must enable it."
---
...
Note: The automatic transcription is only available for browsers that support Speech Recognition (Google Chrome, MS Edge, and Safari). If you join with non-supported browsers, you will see a warning at the bottom of the join audio dialog.
