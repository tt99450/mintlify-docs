...
description: "BigBlueButton gives you many options for the layout."
---

## Fullscreen

You can make the application full screen by selecting the three dots in the upper right-hand corner and selecting **Fullscreen Application.**

<Frame>
  ![Image](/images/image-6.png)
</Frame>

To exit fullscreen, press the escape key.

<Frame>
  ![Image](/images/12223855668109.png)
</Frame>
...
The **Smart layout** will display the webcams at the top of the screen with the presentation area being directly below them.
