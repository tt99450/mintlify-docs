...
![My Logs tab showing connection issues](/images/17574049852301.png)

\*Session Logs are only available to the moderators and will show all issues for all users in the session.

![Session Logs tab showing connection issues for all users in the session](/images/17574118864525.png)
