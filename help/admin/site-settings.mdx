---
title: "Site Settings "
description: "Administrators are able to customize the look and function of their Personal Rooms instance through the Site Settings. This article covers how to..."
---
...
Once this registration method is enabled, Administrators can **I****nvite a user** by navigating back to the **Manage Users**menu, and select the **Invite User**button located to the right of the menu search bar.
...
The pending user(s) can be Approved or Declined by accessing the **Vertical Ellipsis**or **H****amburger Menu**to the right of the listing.
